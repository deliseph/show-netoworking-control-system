...
const AUTHOR = {
  ...
  work: [
    ...
    ['Computer Systems for Theatre', 'https://github.com/deliseph/theatre-computer-systems', 'the year one module this one follows'],
    ['Electronics for Theatre', 'https://github.com/deliseph/electronics-for-theatre', 'the sibling module, on what happens below the connector'],
  ],
};
