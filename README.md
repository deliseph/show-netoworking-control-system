...
- [Computer Systems and Networking for Theatre](https://github.com/deliseph/theatre-computer-systems),
  the year one module this one follows.
- [Electronics for Theatre](https://github.com/deliseph/electronics-for-theatre), the sibling module
  on what happens below the connector.

All three are built on the same engine, and the bilingual glossaries follow
[showstack](https://showstack-inky.vercel.app/) where they overlap.
